...
{
    while($show_data=mysqli_fetch_assoc($query_run1))
    {
?>
<div class="container">
    <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-12">
                                <div class="entry-media pb-4">
                                   ...
                                   <img class="img-fluid post-img"
                                    src="Admin/Upload1/<?php echo $show_data['image'] ;?>" class="img-fluid" style="height: 320px;">
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6 col-sm-12">
                                ...
                                <h3 class="entry-title" style="font-size:19px;">
                                    <a href="post.php?p_id=<?php echo $show_data['id'] ;?>"
                                        rel="bookmark"><?php echo $show_data['title'] ?>
                                    </a>
                                </h3>
                                </div><!-- .entry-header -->

                                <div class="entry-summary the-excerpt">
                                 <p style="font-size: 16px;"><?php echo rtrim(substr($show_data['text'], 0,280)) ;?>....</p>
                                </div><!-- .entry-content -->
                                    ...
                                    <span class="posted-on">_
                                        <a href="#"
                                            ...
                                            <time class="entry-date" datetime="2022-12-22T17:55:46+00:00">
                                                <?php echo $show_data['date'] ?>
                                            </time>
                                        </a>
                                    </span>
                                    <span class="byline">_
                                        <a class="url fn n"
                                            href="blog_php_wordpress.php"><?php echo $show_data['author'] ?>
                                        </a>
                                    </span>
                                ...
                                <div class="btn-readmore">
                                     <a href="post.php?p_id=<?php echo $show_data['id'] ?>" rel="category tag">Read More</a>
