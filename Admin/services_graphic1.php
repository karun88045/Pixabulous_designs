...
$sql = "INSERT INTO `services_graphic1`(`title`, `text`, `image`) VALUES ('$title','$text','$image')";
$query = mysqli_query($mysqli,$sql);
echo"<script>alert('Data has been Deleted successfully');</script>";
move_uploaded_file($tempname1,$destination1);
header('location:services_graphic1.php');
}
...
// select query
$sql1 = "SELECT * FROM `services_graphic1` WHERE id='$id'";
...
$sql2 = "UPDATE `services_graphic1` SET `id`='$d',`title`='$title',`text`='$text',`image`='$image' WHERE id='$id'";
...
// select query
$sql3 = "DELETE FROM `services_graphic1` WHERE id='$id'";
										...
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="col-sm-8 col-sm-offset-2">
													...
													<input class="btn btn-primary" type="submit" name="submit" value="Add Services Graphic1">
												</div>
											</div>
