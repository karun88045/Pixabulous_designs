...
$about_img_left = $_POST['about_img_left'];
...
$about_img_right = $_POST['about_img_right'];
...
$sql = "INSERT INTO `about_index` (`about_index_title`,`about_index_text`,`about_img_left`,`about_img_left_title`,`about_img_left_text`,`about_img_right`,`about_img_right_title`,`about_img_right_text`) values ('$about_index_title','$about_index_text','$about_img_left','$about_img_left_title','$about_img_left_text','$about_img_right','$about_img_right_title','$about_img_right_text')";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add About Us Content </h2>
										...
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<textarea value="<?php echo $row_Id['about_index_title'] ?>" name="about_index_title" id="editor1"  class="form-control"><?php echo $row_Id['about_index_title'] ?></textarea>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<textarea class="form-control" id="editor2"  name="about_index_text" value="<?php echo $row_Id['about_index_text'] ?>"><?php echo $row_Id['about_index_text'] ?></textarea>		 
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-8">
													<!-- <input type="file" class="form-control" name="about_img_left"  value="" > -->
						 							<textarea class="form-control" id="editor3" name="about_img_left"  value="<?php echo $row_Id['about_img_left'] ?>" ><?php echo $row_Id['about_img_left'] ?></textarea>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<textarea id="editor4"  value="<?php echo $row_Id['about_img_left_title'] ?>" name="about_img_left_title"  class="form-control"><?php echo $row_Id['about_img_left_title'] ?></textarea>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<textarea id="editor5"  class="form-control" name="about_img_left_text" value="<?php echo $row_Id['about_img_left_text'] ;?>"><?php echo $row_Id['about_img_left_text'] ;?></textarea>					 
												</div>
											</div>
												<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<textarea class="form-control" id="editor6" name="about_img_right"  value="<?php echo $row_Id['about_img_right'] 
													?>"><?php echo $row_Id['about_img_right'] 
													?></textarea>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<textarea id="editor7"  value="<?php echo $row_Id['about_img_right_title'] ?>" name="about_img_right_title"  class="form-control"><?php echo $row_Id['about_img_right_title'] ?></textarea>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<textarea id="editor8" class="form-control" name="about_img_right_text" value="<?php echo $row_Id['about_img_right_text'] ?>"><?php echo $row_Id['about_img_right_text'] ?></textarea>					 
												</div>
											</div>
										...
										<?php } else { ?>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<textarea  class="form-control" name="about_img_left" id="editor3" value=""></textarea>
											...
											<div class="form-group">
												...
												<label class="col-sm-2 control-label">About Us Image Right</label>
												<div class="col-sm-8">
													<!-- <input type="file" class="form-control" name="about_img_right" id="editor6" value=""> -->
													<textarea class="form-control" name="about_img_right" id="editor6" value=""></textarea>
													...
													<table class="table">
														...
														<tr>
															<thead>
																...
																<td style="height:100px;width:100px;"><?php echo $row['about_img_left'] ;?></td>
																<td><?php echo $row['about_img_left_title'] ;?></td>
																<td><?php echo $row['about_img_left_text'] ;?></td>
																<td style="height:100px;width:100px;"><?php echo $row['about_img_right'] ;?></td>
