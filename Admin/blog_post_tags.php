...
$sql = "INSERT INTO `post_tags`(`title`, `text`) VALUES ('$title','$text')";
$query = mysqli_query($mysqli,$sql);
echo"<script>alert('Data has been Deleted successfully');</script>";
header('location:blog_post_tags.php');
}
...
// select query
$sql1 = "SELECT * FROM `post_tags` WHERE id='$id'";
...
$sql2 = "UPDATE `post_tags` SET id='$id',title='$title',text='$text' WHERE id='$id'";
...
// select query
$sql3 = "DELETE FROM `post_tags` WHERE id='$id'";
...
<head>
	...
	<title>Add Post Tags Content</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add Post Tags Content </h2>
	
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Add Post Tags</div>
									<div class="panel-body">
										...
										<form method="post" class="form-horizontal">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Post Tags Title </label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Post Tags Text </label>
												<div class="col-sm-8">
												...
												<div class="col-md-8" style="margin-left:auto;margin-right: auto;">
													<table class="table">
														<tr>
															<thead>
																<th>ID</th>
																<th>Post Tags Title</th>
																<th>Post Tags Text</th>
