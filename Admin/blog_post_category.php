...
$sql = "INSERT INTO `post_category`(`title`, `text`) VALUES ('$title','$text')";
$query = mysqli_query($mysqli,$sql);
echo"<script>alert('Data has been Deleted successfully');</script>";
header('location:blog_post_category.php');
}
...
$sql2 = "UPDATE `post_category` SET id='$id',title='$title',text='$text' WHERE id='$id'";
...
<head>
	...
	<title>Add Post Category Content</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add Post Category Content </h2>
	
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Add Post Category</div>
									<div class="panel-body">
										...
										<form method="post" class="form-horizontal">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Post Category Title </label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Post Category Text </label>
												<div class="col-sm-8">
