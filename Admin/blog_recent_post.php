...
$sql = "INSERT INTO `recent_post`(`title`, `text`) VALUES ('$title','$text')";
$query = mysqli_query($mysqli,$sql);
echo"<script>alert('Data has been Deleted successfully');</script>";
header('location:blog_recent_post.php');
}
...
// select query
$sql1 = "SELECT * FROM `recent_post` WHERE id='$id'";
...
$sql2 = "UPDATE `recent_post` SET id='$id',title='$title',text='$text' WHERE id='$id'";
...
// select query
$sql3 = "DELETE FROM `recent_post` WHERE id='$id'";
...
<head>
	...
	<title>Add Recent Post Content</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add Recent Post Content </h2>
	
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Add Recent Post</div>
									<div class="panel-body">
										...
										<form method="post" class="form-horizontal">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Recent Post Title </label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Recent Post Text </label>
												<div class="col-sm-8">
												...
												<div class="col-md-8" style="margin-left:auto;margin-right: auto;">
													<table class="table">
														<tr>
															<thead>
																<th>ID</th>
																<th>Recent Post Title</th>
																<th>Recent Post Text</th>
