...
$sql = "INSERT INTO `services_graphic4`(`title`, `text`, `list`, `image`) VALUES ('$title','$text','$list','$image')";
$query = mysqli_query($mysqli,$sql);
echo"<script>alert('Data has been Deleted successfully');</script>";
move_uploaded_file($tempname1,$destination1);
header('location:services_graphic4.php');
}
...
// select query
$sql1 = "SELECT * FROM `services_graphic4` WHERE id='$id'";
...
$sql2 = "UPDATE `services_graphic4` SET id='$d',title='$title',text='$text',list='$list',image='$image' WHERE id='$id'";
...
// select query
$sql3 = "DELETE FROM `services_graphic4` WHERE id='$id'";
										...
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<textarea class="form-control" id="editor3" name="list" value="<?php echo $row['list']; ?>"><?php echo $row['list']; ?></textarea>
											...
											<div class="form-group">
												...
												<div class="col-sm-8 col-sm-offset-2">
													...
													<input class="btn btn-primary" type="submit" name="Update" value="Update Services Graphic1">
												</div>
											</div>
									...
									<?php } else { ?>
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">List</label>
												<div class="col-sm-8">
													<textarea class="form-control" id="editor3" name="list" ></textarea>
											...
											<div class="form-group">
												...
												<div class="col-sm-8 col-sm-offset-2">
													...
													<input class="btn btn-primary" type="submit" name="submit" value="Add Services Graphic4">
												</div>
											</div>
