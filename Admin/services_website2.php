...
$sql = "INSERT INTO `services_website_2`(`title`, `text`, `image`, `image_title`, `image_text`) VALUES ('$title','$text','$image','$image_title','$image_text')";
$query = mysqli_query($con,$sql);
echo"<script>alert('Data has been Deleted successfully');</script>";
move_uploaded_file($tempname1,$destination1);
header('location:services_website2.php');
}
...
// select query
$sql1 = "SELECT * FROM `services_website_2` WHERE id='$id'";
...
$sql2 = "UPDATE `services_website_2` SET id='$d',title='$title',text='$text',image='$image',image_title='$image_title',image_text='$image_text' WHERE id='$id'";
...
// select query
$sql3 = "DELETE FROM `services_website_2` WHERE id='$id'";
										...
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="col-sm-8 col-sm-offset-2">
													...
													<input class="btn btn-primary" type="submit" name="Update" value="Update Services Website2">
												</div>
											</div>
										...
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="col-sm-8 col-sm-offset-2">
													...
													<input class="btn btn-primary" type="submit" name="submit" value="Add Services Website2">
												</div>
											</div>
