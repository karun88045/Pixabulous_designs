...
echo $query2 = mysqli_query($mysqli,$sql2);
...
<head>
	...
	<title>Add Blog Page Content</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add Blog Page Content </h2>
	
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Add Blog Page</div>
										...
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<textarea value="<?php echo $row['about_index_title'] ?>" name="about_index_title" id="editor1"  class="form-control"></textarea>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<textarea class="form-control" id="editor2"  name="about_index_text" value="<?php echo $row['about_index_text'] ?>"></textarea>		 
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-2 control-label">About Image Left</label>
												<div class="col-sm-8">
													<input type="file" class="form-control" name="about_img_left"  value="<?php echo $row['about_img_left'] ?>" >
						 							<!-- <textarea></textarea> -->
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<textarea id="editor3"  value="<?php echo $row['about_img_left_title'] ?>" name="about_img_left_title"  class="form-control"></textarea>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<textarea id="editor4"  class="form-control" name="about_img_left_text" value="<?php echo $row['about_img_left_text'] ;?>"></textarea>					 
												</div>
											</div>
												<div class="form-group">
												<label class="col-sm-2 control-label">About Us Image Right</label>
												<div class="col-sm-8">
													<input type="file" class="form-control" name="about_img_right"  value="<?php echo $row['about_img_right'] ?>" >
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<textarea id="editor5"  value="<?php echo $row['about_img_right_title'] ?>" name="about_img_right_title"  class="form-control"></textarea>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<textarea id="editor6" class="form-control" name="about_img_right_text" value="<?php echo $row['about_img_right_text'] ?>"></textarea>					 
												</div>
											</div>
